...
export const translations = {
  en: {
    ...
    releaseUpdateTitle: "New version available",
    releaseUpdateMessage: "New version available: {version}. Open the releases page?",
    releaseUpdateOpen: "Open releases page",
    releaseUpdateLater: "Later",
    releaseUpdateOpenFailed: "Could not open the releases page: {message}",
    closeApp: "Close app",
    playlistStart: "Start",
    ...
    playlistRemainingTandas: "Remaining Tandas",
    ...
    libraryWorkflowStepAnalysis: "Run setup / import / rescan",
    ...
    trackEditorDelete: "Delete track",
    trackEditorDeleteTitle: "Delete track",
    trackEditorDeleteMessage:
      "Remove this track from Tanda Forge? It will no longer appear in searches or be used in tandas, playlists, or auto-fill.",
    trackEditorDeleteFileOption: "Also remove the audio file from disk (subject to permissions)",
    undeleteTracksTitle: "Un-delete",
    undeleteTracksSummary: "Restore tracks previously removed from Tanda Forge when their audio files remain available.",
    undeleteTracksButton: "Restore selected tracks",
    undeleteTracksEmpty: "No deleted tracks.",
    undeleteTrackLabel: "{title} — {artist}",
    undeleteTracksRestored: "Restored {count} track(s).",
    ...
    systemExportRunningBackground:
      "System backup is still running in the background: {path}",
    systemExportStartedBackground:
      "System backup started in the background: {path}",
    systemExportDone: "System export created at {path}",
    systemExportFailed: "System export failed: {message}",
    systemExportProgressTitle: "Export progress",
    systemBackupStepDatabase: "Database",
    systemBackupStepDatabaseWal: "Database WAL",
    systemBackupStepDatabaseShm: "Database SHM",
    systemBackupStepWaveforms: "Waveforms",
    systemBackupStepCompressedAudioCache: "Compressed audio cache",
    systemBackupStepPlayableAudioCache: "Playable audio cache",
    systemBackupStepRendererErrorsLog: "Renderer error log",
    systemBackupStepPlaybackDiagnosticsLog: "Playback diagnostics log",
    systemBackupStepManifest: "Backup manifest",
    systemBackupStepStatePending: "Pending",
    systemBackupStepStateRunning: "Running",
    systemBackupStepStateComplete: "Complete",
    systemBackupStepStateFailed: "Failed",
    ...
    statusTrackDeleted: "Track removed from Tanda Forge.",
    statusTrackDeletedWithFile: "Track removed from Tanda Forge and the audio file was deleted.",
    statusTrackDeletedFileFailed:
      "Track removed from Tanda Forge, but the audio file could not be deleted: {message}",
    statusTrackDeleteFailed: "Track could not be removed.",
    ...
    statusRootRemoved:
      "Removed library folder {path}. Tracks removed: {tracks}. Tandas invalidated: {tandas}.",
    ...
    displayLastTandas1: "Last tanda",
    displayLastTandas2: "Last two tandas",
    displayLastTandas3: "Last three tandas",
    displayLastTandas4: "Last four tandas",
    displayLastTandas5: "Last five tandas",
  ...
  es: {
    appTitle: "Tanda Forge",
    appSubtitle: "Version: {version} © David Goddard 2026",
    releaseUpdateTitle: "Nueva version disponible",
    releaseUpdateMessage: "Nueva version disponible: {version}. Abrir la pagina de lanzamientos?",
    releaseUpdateOpen: "Abrir lanzamientos",
    releaseUpdateLater: "Luego",
    releaseUpdateOpenFailed: "No se pudo abrir la pagina de lanzamientos: {message}",
    closeApp: "Cerrar app",
    ...
    playlistRemainingTandas: "Tandas restantes",
    ...
    libraryWorkflowStepAnalysis: "Ejecutar configuracion / importacion / reescaneo",
    libraryWorkflowStepAnalysisHelp:
    ...
    confirmCloseWhileBackupRunning:
      "Aun se esta ejecutando una copia de seguridad del sistema. Si cierra la aplicacion ahora se detendra. ¿Cerrar la aplicacion?",
    confirmCloseWhilePlayingAndBackupRunning:
      "La musica sigue sonando y aun se esta ejecutando una copia de seguridad del sistema. Si cierra la aplicacion ahora se detendran ambas. ¿Cerrar la aplicacion?",
    confirmDataLocationChange:
    ...
    trackEditorDelete: "Eliminar tema",
    trackEditorDeleteTitle: "Eliminar tema",
    trackEditorDeleteMessage: "¿Quitar este tema de Tanda Forge? No aparecerá en búsquedas ni se usará en tandas, listas o autocompletado.",
    trackEditorDeleteFileOption: "Eliminar también el archivo de audio del disco (sujeto a permisos)",
    undeleteTracksTitle: "Restaurar eliminados",
    undeleteTracksSummary: "Restaura temas eliminados anteriormente de Tanda Forge si sus archivos siguen disponibles.",
    undeleteTracksButton: "Restaurar temas seleccionados",
    undeleteTracksEmpty: "No hay temas eliminados.",
    undeleteTrackLabel: "{title} — {artist}",
    undeleteTracksRestored: "Se restauraron {count} tema(s).",
    unknownTitle: "Título desconocido",
    unknownArtist: "Artista desconocido",
    statusTrackDeleted: "Tema eliminado de Tanda Forge.",
    statusTrackDeletedWithFile: "Tema eliminado de Tanda Forge y archivo de audio borrado.",
    statusTrackDeletedFileFailed: "Tema eliminado de Tanda Forge, pero no se pudo borrar el archivo: {message}",
    statusTrackDeleteFailed: "No se pudo eliminar el tema.",
    ...
    systemExportRunningBackground:
      "La copia de seguridad del sistema sigue ejecutandose en segundo plano: {path}",
    systemExportStartedBackground:
      "La copia de seguridad del sistema se inicio en segundo plano: {path}",
    systemExportDone: "Exportacion creada en {path}",
    systemExportFailed: "La exportacion fallo: {message}",
    systemExportProgressTitle: "Progreso de exportacion",
    systemBackupStepDatabase: "Base de datos",
    systemBackupStepDatabaseWal: "WAL de base de datos",
    systemBackupStepDatabaseShm: "SHM de base de datos",
    systemBackupStepWaveforms: "Formas de onda",
    systemBackupStepCompressedAudioCache: "Cache de audio comprimido",
    systemBackupStepPlayableAudioCache: "Cache de audio reproducible",
    systemBackupStepRendererErrorsLog: "Registro de errores del renderer",
    systemBackupStepPlaybackDiagnosticsLog: "Registro de diagnostico de reproduccion",
    systemBackupStepManifest: "Manifiesto de respaldo",
    systemBackupStepStatePending: "Pendiente",
    systemBackupStepStateRunning: "En curso",
    systemBackupStepStateComplete: "Completado",
    systemBackupStepStateFailed: "Fallido",
    ...
    removeRootButton: "Quitar",
    confirmRemoveRoot:
      "¿Quitar esta carpeta de {kind} de la biblioteca?\n\nRuta: {path}\nTemas eliminados: {tracks}\nTandas invalidadas: {tandas}\nPlaylists marcadas como invalidas: {playlists}\n\nEsto elimina de la base de datos todos los temas de esa carpeta e invalida las tandas dependientes.",
    statusRootRemoved:
      "Carpeta de biblioteca quitada {path}. Temas eliminados: {tracks}. Tandas invalidadas: {tandas}.",
    ...
    displayLastTandas1: "Ultima tanda",
    displayLastTandas2: "Ultimas dos tandas",
    displayLastTandas3: "Ultimas tres tandas",
    displayLastTandas4: "Ultimas cuatro tandas",
    displayLastTandas5: "Ultimas cinco tandas",
  ...
  fr: {
    appTitle: "Tanda Forge",
    appSubtitle: "Version: {version} © David Goddard 2026",
    releaseUpdateTitle: "Nouvelle version disponible",
    releaseUpdateMessage: "Nouvelle version disponible : {version}. Ouvrir la page des versions ?",
    releaseUpdateOpen: "Ouvrir les versions",
    releaseUpdateLater: "Plus tard",
    releaseUpdateOpenFailed: "Impossible d'ouvrir la page des versions : {message}",
    ...
    libraryWorkflowStepAnalysis: "Lancer la configuration / l'import / la nouvelle analyse",
    libraryWorkflowStepAnalysisHelp:
    ...
    confirmCloseWhileBackupRunning:
      "Une sauvegarde systeme est toujours en cours. Si vous fermez l'application maintenant, elle sera arretee. Fermer l'application ?",
    confirmCloseWhilePlayingAndBackupRunning:
      "La musique joue encore et une sauvegarde systeme est toujours en cours. Si vous fermez l'application maintenant, les deux s'arreteront. Fermer l'application ?",
    confirmDataLocationChange:
    ...
    trackEditorDelete: "Supprimer la piste",
    trackEditorDeleteTitle: "Supprimer la piste",
    trackEditorDeleteMessage: "Retirer cette piste de Tanda Forge ? Elle ne sera plus recherchée ni utilisée dans les tandas, playlists ou le remplissage automatique.",
    trackEditorDeleteFileOption: "Supprimer aussi le fichier audio du disque (selon les autorisations)",
    undeleteTracksTitle: "Restaurer les suppressions",
    undeleteTracksSummary: "Restaure les pistes retirées de Tanda Forge si leurs fichiers audio restent disponibles.",
    undeleteTracksButton: "Restaurer les pistes sélectionnées",
    undeleteTracksEmpty: "Aucune piste supprimée.",
    undeleteTrackLabel: "{title} — {artist}",
    undeleteTracksRestored: "{count} piste(s) restaurée(s).",
    unknownTitle: "Titre inconnu",
    unknownArtist: "Artiste inconnu",
    statusTrackDeleted: "Piste retirée de Tanda Forge.",
    statusTrackDeletedWithFile: "Piste retirée de Tanda Forge et fichier audio supprimé.",
    statusTrackDeletedFileFailed: "Piste retirée de Tanda Forge, mais le fichier n’a pas pu être supprimé : {message}",
    statusTrackDeleteFailed: "La piste n’a pas pu être retirée.",
    ...
    systemExportRunningBackground:
      "La sauvegarde systeme est toujours en cours en arriere-plan : {path}",
    systemExportStartedBackground:
      "La sauvegarde systeme a demarre en arriere-plan : {path}",
    systemExportDone: "Export cree dans {path}",
    systemExportFailed: "Echec de l'export: {message}",
    systemExportProgressTitle: "Progression de l'export",
    systemBackupStepDatabase: "Base de donnees",
    systemBackupStepDatabaseWal: "WAL de la base de donnees",
    systemBackupStepDatabaseShm: "SHM de la base de donnees",
    systemBackupStepWaveforms: "Formes d'onde",
    systemBackupStepCompressedAudioCache: "Cache audio compresse",
    systemBackupStepPlayableAudioCache: "Cache audio lisible",
    systemBackupStepRendererErrorsLog: "Journal des erreurs du renderer",
    systemBackupStepPlaybackDiagnosticsLog: "Journal de diagnostic de lecture",
    systemBackupStepManifest: "Manifeste de sauvegarde",
    systemBackupStepStatePending: "En attente",
    systemBackupStepStateRunning: "En cours",
    systemBackupStepStateComplete: "Termine",
    systemBackupStepStateFailed: "Echec",
    ...
    rootCortina: "Cortina",
    rootBackground: "Fond",
    removeRootButton: "Retirer",
    confirmRemoveRoot:
      "Retirer ce dossier {kind} de la bibliotheque ?\n\nChemin : {path}\nPistes supprimees : {tracks}\nTandas invalidees : {tandas}\nPlaylists marquees invalides : {playlists}\n\nCela supprime de la base de donnees tous les titres de ce dossier et invalide les tandas dependantes.",
    statusRootRemoved:
      "Dossier de bibliotheque retire {path}. Pistes supprimees : {tracks}. Tandas invalidees : {tandas}.",
    ...
    displayLastTandas1: "Derniere tanda",
    displayLastTandas2: "Deux dernieres tandas",
    displayLastTandas3: "Trois dernieres tandas",
    displayLastTandas4: "Quatre dernieres tandas",
    displayLastTandas5: "Cinq dernieres tandas",
  ...
  de: {
    appTitle: "Tanda Forge",
    appSubtitle: "Version: {version} © David Goddard 2026",
    releaseUpdateTitle: "Neue Version verfuegbar",
    releaseUpdateMessage: "Neue Version verfuegbar: {version}. Release-Seite oeffnen?",
    releaseUpdateOpen: "Releases oeffnen",
    releaseUpdateLater: "Spaeter",
    releaseUpdateOpenFailed: "Release-Seite konnte nicht geoeffnet werden: {message}",
    ...
    playlistRemainingTandas: "Verbleibende Tandas",
    playlistCurrentPerformanceStop:
    ...
    libraryWorkflowStepAnalysis: "Einrichtung / Import / erneuten Scan ausfuehren",
    libraryWorkflowStepAnalysisHelp:
    ...
    confirmCloseWhileBackupRunning:
      "Eine Systemsicherung laeuft noch. Wenn die App jetzt geschlossen wird, wird sie gestoppt. App schliessen?",
    confirmCloseWhilePlayingAndBackupRunning:
      "Die Musik spielt noch und eine Systemsicherung laeuft noch. Wenn die App jetzt geschlossen wird, werden beide gestoppt. App schliessen?",
    confirmDataLocationChange:
    ...
    trackEditorDelete: "Track löschen",
    trackEditorDeleteTitle: "Track löschen",
    trackEditorDeleteMessage: "Diesen Track aus Tanda Forge entfernen? Er erscheint nicht mehr in Suchen und wird nicht für Tandas, Playlists oder Auto-Fill verwendet.",
    trackEditorDeleteFileOption: "Audiodatei auch vom Datenträger löschen (sofern berechtigt)",
    undeleteTracksTitle: "Löschen rückgängig",
    undeleteTracksSummary: "Stellt aus Tanda Forge entfernte Tracks wieder her, wenn die Audiodateien noch verfügbar sind.",
    undeleteTracksButton: "Ausgewählte Tracks wiederherstellen",
    undeleteTracksEmpty: "Keine gelöschten Tracks.",
    undeleteTrackLabel: "{title} — {artist}",
    undeleteTracksRestored: "{count} Track(s) wiederhergestellt.",
    unknownTitle: "Unbekannter Titel",
    unknownArtist: "Unbekannter Künstler",
    statusTrackDeleted: "Track aus Tanda Forge entfernt.",
    statusTrackDeletedWithFile: "Track aus Tanda Forge entfernt und Audiodatei gelöscht.",
    statusTrackDeletedFileFailed: "Track entfernt, aber die Audiodatei konnte nicht gelöscht werden: {message}",
    statusTrackDeleteFailed: "Track konnte nicht entfernt werden.",
    ...
    systemExportRunningBackground:
      "Die Systemsicherung laeuft noch im Hintergrund: {path}",
    systemExportStartedBackground:
      "Die Systemsicherung wurde im Hintergrund gestartet: {path}",
    systemExportDone: "Systemexport erstellt unter {path}",
    systemExportFailed: "Systemexport fehlgeschlagen: {message}",
    systemExportProgressTitle: "Exportfortschritt",
    systemBackupStepDatabase: "Datenbank",
    systemBackupStepDatabaseWal: "Datenbank-WAL",
    systemBackupStepDatabaseShm: "Datenbank-SHM",
    systemBackupStepWaveforms: "Wellenformen",
    systemBackupStepCompressedAudioCache: "Komprimierter Audio-Cache",
    systemBackupStepPlayableAudioCache: "Abspielbarer Audio-Cache",
    systemBackupStepRendererErrorsLog: "Renderer-Fehlerprotokoll",
    systemBackupStepPlaybackDiagnosticsLog: "Wiedergabe-Diagnoseprotokoll",
    systemBackupStepManifest: "Backup-Manifest",
    systemBackupStepStatePending: "Ausstehend",
    systemBackupStepStateRunning: "Laufend",
    systemBackupStepStateComplete: "Abgeschlossen",
    systemBackupStepStateFailed: "Fehlgeschlagen",
    ...
    removeRootButton: "Entfernen",
    confirmRemoveRoot:
      "Diesen {kind}-Ordner aus der Bibliothek entfernen?\n\nPfad: {path}\nEntfernte Titel: {tracks}\nUngueltig gemachte Tandas: {tandas}\nAls ungueltig markierte Playlists: {playlists}\n\nDadurch werden alle Titel aus diesem Ordner aus der Bibliotheksdatenbank entfernt und abhaengige Tandas ungueltig gemacht.",
    statusRootRemoved:
      "Bibliotheksordner entfernt {path}. Entfernte Titel: {tracks}. Ungueltig gemachte Tandas: {tandas}.",
    ...
    displayLastTandas3: "Letzte drei Tandas",
    displayLastTandas4: "Letzte vier Tandas",
    displayLastTandas5: "Letzte funf Tandas",
  ...
  pt: {
    appTitle: "Tanda Forge",
    appSubtitle: "Version: {version} © David Goddard 2026",
    releaseUpdateTitle: "Nova versao disponivel",
    releaseUpdateMessage: "Nova versao disponivel: {version}. Abrir a pagina de releases?",
    releaseUpdateOpen: "Abrir releases",
    releaseUpdateLater: "Depois",
    releaseUpdateOpenFailed: "Nao foi possivel abrir a pagina de releases: {message}",
    closeApp: "Fechar app",
    playlistStart: "Iniciar",
    ...
    libraryWorkflowStepAnalysis: "Executar configuracao / importacao / nova analise",
    libraryWorkflowStepAnalysisHelp:
    ...
    confirmCloseWhileBackupRunning:
      "Uma copia de seguranca do sistema ainda esta em execucao. Se fechar a aplicacao agora, ela sera interrompida. Fechar a aplicacao?",
    confirmCloseWhilePlayingAndBackupRunning:
      "A musica ainda esta a tocar e uma copia de seguranca do sistema ainda esta em execucao. Se fechar a aplicacao agora, ambas serao interrompidas. Fechar a aplicacao?",
    confirmDataLocationChange:
    ...
    trackEditorDelete: "Excluir faixa",
    trackEditorDeleteTitle: "Excluir faixa",
    trackEditorDeleteMessage: "Remover esta faixa do Tanda Forge? Ela não aparecerá em pesquisas nem será usada em tandas, playlists ou preenchimento automático.",
    trackEditorDeleteFileOption: "Também remover o arquivo de áudio do disco (sujeito a permissões)",
    undeleteTracksTitle: "Desfazer exclusão",
    undeleteTracksSummary: "Restaura faixas removidas do Tanda Forge quando os arquivos ainda estão disponíveis.",
    undeleteTracksButton: "Restaurar faixas selecionadas",
    undeleteTracksEmpty: "Nenhuma faixa excluída.",
    undeleteTrackLabel: "{title} — {artist}",
    undeleteTracksRestored: "{count} faixa(s) restaurada(s).",
    unknownTitle: "Título desconhecido",
    unknownArtist: "Artista desconhecido",
    statusTrackDeleted: "Faixa removida do Tanda Forge.",
    statusTrackDeletedWithFile: "Faixa removida do Tanda Forge e arquivo de áudio excluído.",
    statusTrackDeletedFileFailed: "Faixa removida, mas o arquivo não pôde ser excluído: {message}",
    statusTrackDeleteFailed: "Não foi possível remover a faixa.",
    trackEditorReset: "Reiniciar",
    trackEditorCancel: "Cancelar",
    ...
    systemExportRunningBackground:
      "A copia de seguranca do sistema ainda esta em execucao em segundo plano: {path}",
    systemExportStartedBackground:
      "A copia de seguranca do sistema foi iniciada em segundo plano: {path}",
    systemExportDone: "Exportacao criada em {path}",
    systemExportFailed: "A exportacao falhou: {message}",
    systemExportProgressTitle: "Progresso da exportacao",
    systemBackupStepDatabase: "Base de dados",
    systemBackupStepDatabaseWal: "WAL da base de dados",
    systemBackupStepDatabaseShm: "SHM da base de dados",
    systemBackupStepWaveforms: "Formas de onda",
    systemBackupStepCompressedAudioCache: "Cache de audio comprimido",
    systemBackupStepPlayableAudioCache: "Cache de audio reproduzivel",
    systemBackupStepRendererErrorsLog: "Registo de erros do renderer",
    systemBackupStepPlaybackDiagnosticsLog: "Registo de diagnostico de reproducao",
    systemBackupStepManifest: "Manifesto da copia de seguranca",
    systemBackupStepStatePending: "Pendente",
    systemBackupStepStateRunning: "Em execucao",
    systemBackupStepStateComplete: "Concluido",
    systemBackupStepStateFailed: "Falhou",
    ...
    removeRootButton: "Remover",
    confirmRemoveRoot:
      "Remover esta pasta de {kind} da biblioteca?\n\nCaminho: {path}\nFaixas removidas: {tracks}\nTandas invalidadas: {tandas}\nPlaylists marcadas como invalidas: {playlists}\n\nIsto remove da base de dados todas as faixas dessa pasta e invalida as tandas dependentes.",
    statusRootRemoved:
      "Pasta da biblioteca removida {path}. Faixas removidas: {tracks}. Tandas invalidadas: {tandas}.",
    ...
    displayVariousArtists: "Varios artistas",
    displayLastTandas1: "Ultima tanda",
    displayLastTandas2: "Ultimas duas tandas",
    displayLastTandas3: "Ultimas tres tandas",
    displayLastTandas4: "Ultimas quatro tandas",
    displayLastTandas5: "Ultimas cinco tandas",
  ...
  it: {
    appTitle: "Tanda Forge",
    appSubtitle: "Version: {version} © David Goddard 2026",
    releaseUpdateTitle: "Nuova versione disponibile",
    releaseUpdateMessage: "Nuova versione disponibile: {version}. Aprire la pagina delle release?",
    releaseUpdateOpen: "Apri release",
    releaseUpdateLater: "Dopo",
    releaseUpdateOpenFailed: "Impossibile aprire la pagina delle release: {message}",
    closeApp: "Chiudi app",
    playlistStart: "Avvia",
    ...
    playlistRemainingTandas: "Tandas rimanenti",
    playlistCurrentPerformanceStop:
    ...
    libraryWorkflowStepAnalysis: "Esegui configurazione / importazione / nuova scansione",
    libraryWorkflowStepAnalysisHelp:
    ...
    trackEditorDelete: "Elimina brano",
    trackEditorDeleteTitle: "Elimina brano",
    trackEditorDeleteMessage: "Rimuovere questo brano da Tanda Forge? Non apparirà più nelle ricerche né sarà usato in tande, playlist o riempimento automatico.",
    trackEditorDeleteFileOption: "Rimuovi anche il file audio dal disco (se consentito)",
    undeleteTracksTitle: "Annulla eliminazione",
    undeleteTracksSummary: "Ripristina i brani rimossi da Tanda Forge se i file audio sono ancora disponibili.",
    undeleteTracksButton: "Ripristina brani selezionati",
    undeleteTracksEmpty: "Nessun brano eliminato.",
    undeleteTrackLabel: "{title} — {artist}",
    undeleteTracksRestored: "Ripristinati {count} brani.",
    unknownTitle: "Titolo sconosciuto",
    unknownArtist: "Artista sconosciuto",
    statusTrackDeleted: "Brano rimosso da Tanda Forge.",
    statusTrackDeletedWithFile: "Brano rimosso da Tanda Forge e file audio eliminato.",
    statusTrackDeletedFileFailed: "Brano rimosso, ma non è stato possibile eliminare il file: {message}",
    statusTrackDeleteFailed: "Impossibile rimuovere il brano.",
    ...
    systemExportRunningBackground:
      "Il backup di sistema e ancora in esecuzione in background: {path}",
    systemExportStartedBackground:
      "Il backup di sistema e stato avviato in background: {path}",
    systemExportDone: "Esportazione creata in {path}",
    systemExportFailed: "Esportazione non riuscita: {message}",
    systemExportProgressTitle: "Avanzamento esportazione",
    systemBackupStepDatabase: "Database",
    systemBackupStepDatabaseWal: "WAL del database",
    systemBackupStepDatabaseShm: "SHM del database",
    systemBackupStepWaveforms: "Forme d'onda",
    systemBackupStepCompressedAudioCache: "Cache audio compressa",
    systemBackupStepPlayableAudioCache: "Cache audio riproducibile",
    systemBackupStepRendererErrorsLog: "Registro errori renderer",
    systemBackupStepPlaybackDiagnosticsLog: "Registro diagnostica riproduzione",
    systemBackupStepManifest: "Manifest di backup",
    systemBackupStepStatePending: "In attesa",
    systemBackupStepStateRunning: "In corso",
    systemBackupStepStateComplete: "Completato",
    systemBackupStepStateFailed: "Non riuscito",
    ...
    removeRootButton: "Rimuovi",
    confirmRemoveRoot:
      "Rimuovere questa cartella {kind} dalla libreria?\n\nPercorso: {path}\nBrani rimossi: {tracks}\nTandas invalidate: {tandas}\nPlaylist segnate come non valide: {playlists}\n\nQuesto rimuove dal database della libreria tutti i brani di quella cartella e invalida le tandas dipendenti.",
    statusRootRemoved:
      "Cartella di libreria rimossa {path}. Brani rimossi: {tracks}. Tandas invalidate: {tandas}.",
    ...
    displayLastTandas1: "Ultima tanda",
    displayLastTandas2: "Ultime due tandas",
    displayLastTandas3: "Ultime tre tandas",
    displayLastTandas4: "Ultime quattro tandas",
    displayLastTandas5: "Ultime cinque tandas",
...
translations.is = {
  ...translations.en,
  appSubtitle: "Version: {version} © David Goddard 2026",
  releaseUpdateTitle: "Ny utgafa tiltæk",
  releaseUpdateMessage: "Ny utgafa tiltæk: {version}. Opna utgafusidu?",
  releaseUpdateOpen: "Opna utgafur",
  releaseUpdateLater: "Seinna",
  releaseUpdateOpenFailed: "Ekki tokst að opna utgafusiduna: {message}",
  ...
  playlistRemainingTandas: "Tandas eftir",
  ...
  confirmCloseWhileBackupRunning:
    "Kerfisafrit er enn i gangi. Ef forritinu er lokað núna stöðvast það. Loka forritinu?",
  confirmCloseWhilePlayingAndBackupRunning:
    "Tónlist er enn í spilun og kerfisafrit er enn i gangi. Ef forritinu er lokað núna stöðvast hvort tveggja. Loka forritinu?",
  cancel: "Hætta við",
  playNow: "Spila núna",
  confirmLivePerformanceTrackPlay:
  ...
  systemExportRunningBackground:
    "Kerfisafrit er enn i gangi i bakgrunni: {path}",
  systemExportStartedBackground:
    "Kerfisafrit var ræst i bakgrunni: {path}",
  systemExportDone: "Kerfisútflutningur vistaður í {path}",
  systemExportFailed: "Kerfisútflutningur mistókst: {message}",
  systemExportProgressTitle: "Framvinda útflutnings",
  systemBackupStepDatabase: "Gagnagrunnur",
  systemBackupStepDatabaseWal: "WAL gagnagrunns",
  systemBackupStepDatabaseShm: "SHM gagnagrunns",
  systemBackupStepWaveforms: "Bylgjuform",
  systemBackupStepCompressedAudioCache: "Þjappað hljóðskyndiminni",
  systemBackupStepPlayableAudioCache: "Spilanlegt hljóðskyndiminni",
  systemBackupStepRendererErrorsLog: "Villuskrá renderer",
  systemBackupStepPlaybackDiagnosticsLog: "Greiningarskrá afspilunar",
  systemBackupStepManifest: "Afritsskrá",
  systemBackupStepStatePending: "Í bið",
  systemBackupStepStateRunning: "Í gangi",
  systemBackupStepStateComplete: "Lokið",
  systemBackupStepStateFailed: "Mistókst",
  ...
  libraryWorkflowStepAnalysis: "Keyra uppsetningu / innflutning / endurskönnun",
  libraryWorkflowStepAnalysisHelp:
  ...
  displayLastTandas3: "Sidustu thrjar tandur",
  displayLastTandas4: "Sidustu fjorar tandur",
  displayLastTandas5: "Sidustu fimm tandur",
