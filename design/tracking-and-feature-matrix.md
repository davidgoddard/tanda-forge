...
| FR-001.4 | Guided setup and recovery | Yes | Yes | Done: one Library-tab action now provides a resumable scan/build/compression recovery flow, while destructive legacy migration is exposed as a separate explicit action. |
