...
| UI-050 | Configuration panel | Yes | Partial | Done: Library/System/Playlist/Display Board tabs, diagnostics paths and waveform test. Missing: gain target controls and UI visibility toggles. |
