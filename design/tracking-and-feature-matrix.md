...
| FR-001.4 | Guided setup and recovery | Yes | Yes | Done: one Library-tab action now runs legacy import when detected, scans music + cortinas, regenerates waveform artifacts as needed, and bulk-renders compressed companions in order. |
